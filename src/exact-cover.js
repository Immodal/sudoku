...
}; // semicolon needed to separate the exactCover object from the IIFE below.

// Should refactor this module to take numbers rather than a Grid object, too lazy right now
(function () {
